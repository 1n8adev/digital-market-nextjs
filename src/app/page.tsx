...
const perks = [
  ...
  },
  {
    ...
    icon: CheckCircle,
    description:
      'Every Asset on our platform is verified by the team to ensure highest quality standard ',
  },
  {
    name: 'For the planet ',
    icon: Leaf,
...
export default function Home() {
  return (
    <>
      <MaxWithWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl max-auto">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Your marketplace for high-quality{' '}
            <span className="text-orange-500">digital asset</span>.
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to syncDigital. Every Asset on our Platform is verified by
